...
val Naranja = Color(0xFFFFA500) // Naranja para el botón submit
val Amarillo = Color(0xFFFFEB3B) // Amarillo para el botón skip
val Blanco = Color(0xFFFFFFFF) // Fondo blanco
val GrisClaro = Color(0xFFBDBDBD) // Gris para texto
val GrisOscuro = Color(0xFF212121) //  para otros textos

// Colores del tema claro
val md_theme_light_primary = Color(0xFF00796B) // verde oscuro
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFDEE0FF)
val md_theme_light_onPrimaryContainer = Color(0xFF00105C)
val md_theme_light_secondary = Color(0xFF795548) // Marron
